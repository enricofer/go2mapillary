...
<qgis maximumScale="1e+08" version="2.99.0-Master" minimumScale="0" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1" simplifyLocal="1">
    ...
    <symbols>
      <symbol name="0" alpha="1" clip_to_extent="1" type="line">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="54,175,108,255" k="line_color"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" sizeLegend="0" diagramType="Histogram">
    <DiagramCategory transparency="0" backgroundAlpha="255" backgroundColor="#ffffff" height="15" width="15" penWidth="0" angleOffset="1440" labelPlacementMethod="XHeight" penColor="#000000" minScaleDenominator="inf" minimumSize="0" barWidth="5" enabled="0" scaleDependency="Area" scaleBasedVisibility="0" diagramOrientation="Up" maxScaleDenominator="1e+08" penAlpha="255" lineSizeScale="0,0,0,0,0,0" sizeScale="0,0,0,0,0,0" lineSizeType="MM" sizeType="MM">
  ...
  <DiagramLayerSettings priority="0" zIndex="0" showAll="1" linePlacementFlags="18" obstacle="0" dist="0" placement="2">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    <alias name="" index="0" field="userkey"/>
    <alias name="" index="1" field="key"/>
    <alias name="" index="2" field="pano"/>
    <alias name="" index="3" field="captured_at"/>
    <alias name="" index="4" field="ikey"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default expression="" field="userkey"/>
    <default expression="" field="key"/>
    <default expression="" field="pano"/>
    <default expression="" field="captured_at"/>
    <default expression="" field="ikey"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="userkey"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="key"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="pano"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="captured_at"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="ikey"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="userkey"/>
    <constraint desc="" exp="" field="key"/>
    <constraint desc="" exp="" field="pano"/>
    <constraint desc="" exp="" field="captured_at"/>
    <constraint desc="" exp="" field="ikey"/>
  </constraintExpressions>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      <column name="userkey" hidden="0" width="-1" type="field"/>
      <column name="ikey" hidden="0" width="-1" type="field"/>
      <column name="pano" hidden="0" width="-1" type="field"/>
      <column name="captured_at" hidden="0" width="-1" type="field"/>
      <column name="key" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <expressionfields/>
  <previewExpression>userkey</previewExpression>
  <mapTip></mapTip>
